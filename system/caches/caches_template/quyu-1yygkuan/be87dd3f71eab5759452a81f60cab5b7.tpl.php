...
<!-- 内页顶部 -->
	...
	<section class="navautos">
	<div class="textnav2">
    </div>

		<div class="wrapnavautos">
				<div id="navautos1">
					<a href="<?php echo WEB_PATH; ?>/mobile/mobile/glist"><img src="<?php echo G_TEMPLATES_IMAGE; ?>/wap_img/nava1.png"></a>
				</div>
				<div class="textnavword">
				<p style="text-align:center;font-size: 14px;color:#bbb">全部商品</p>
				
				</div>
		</div>
		<div class="wrapnavautos">
				<div id="navautos2">
					<a href="<?php echo WEB_PATH; ?>/mobile/shaidan/"><img src="<?php echo G_TEMPLATES_IMAGE; ?>/wap_img/nava2.png"></a>
				</div>
				<div class="textnavword">
				<p style="text-align:center;font-size: 14px;color:#bbb">幸运晒单</p>
				
				</div>
		</div>
		<div class="wrapnavautos">
				<div id="navautos3">
					<a href="http://wpa.qq.com/msgrd?v=3&uin=10373458&site=oicqzone.com&menu=yes"><img src="<?php echo G_TEMPLATES_IMAGE; ?>/wap_img/nava3.png"></a>
				</div>
				<div class="textnavword">
				<p style="text-align:center;font-size: 14px;color:#bbb;">联系客服</p>
				
				</div>
		</div>
		<div class="wrapnavautos">
				<div id="navautos4">
					<a href="<?php echo WEB_PATH; ?>/mobile/home/userrecharge"><img src="<?php echo G_TEMPLATES_IMAGE; ?>/wap_img/nava4.png"></a>
				</div>
				<div class="textnavword">
				<p style="text-align:center;font-size: 14px;color:#bbb">在线充值</p>
             ...
             ?>
			        <li>
		                <a href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $qishu['id']; ?>" class="u-lott-pic">
		                    <img src="<?php echo G_TEMPLATES_IMAGE; ?>/wap_img/loading.gif" src2="<?php echo G_UPLOAD_PATH; ?>/<?php echo $qishu['thumb']; ?>" border="0" alt="" />
		                </a>
	    ...
	    <article id="autoLotteryBox" class="clearfix h5-1yyg-w310 m-round overflow">
			...
			<li class="m-xs-li" txt="<?php echo $shop['time_H']; ?>点" codeid="<?php echo $shop['id']; ?>" uweb="<?php echo idjia($shop['q_uid']); ?>">
				<article class="clearfix m-xs-ct m-xs-End">
					<div class="u-xs-pic">
						<div class="z-xs-pic">
						<a href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $shop['id']; ?>"><img src="<?php echo G_TEMPLATES_IMAGE; ?>/wap_img/loading.gif" src2="<?php echo G_UPLOAD_PATH; ?>/<?php echo $shop['thumb']; ?>" border=0 /></a>
						</div>
			            ...
			            <div class="f_bor_tr">
			                <div class="m-tj-pic">
			                    <a href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $renqi['id']; ?>" class="u-lott-pic">
			                        <img src="<?php echo G_TEMPLATES_IMAGE; ?>/wap_img/loading.gif" src2="<?php echo G_UPLOAD_PATH; ?>/<?php echo $renqi['thumb']; ?>" border=0 alt="" />
			                    </a>
