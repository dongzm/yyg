...
<form name="myform" action="" method="post" enctype="multipart/form-data">
  <table width="100%" cellspacing="0">
		<tr>
			...
			<td>
				<input type="text" id="qq" name="qq" value="<?php echo $recomone['qq'];?>" class="input-text wid300" />
			</td>
		</tr>
		<tr>
			<td width="120" align="right">加群代码:</td>
			<td>
				<textarea id="qqurl" name="qqurl" class="input-text wid300" style="height:70px;"><?php echo $recomone['qqurl'];?></textarea>
			</td>
		</tr>
		 <tr>
			<td width="120" align="right">QQ群名称:</td>
			<td>
				<input type="text" id="name" name="name" value="<?php echo $recomone['name'];?>"" class="input-text wid300" />
			</td>
		</tr>			
		<tr>
			<td width="120" align="right">QQ群是否已满:</td>
			<td>
				<input type="radio" id="full" name="full" value="已满" <?php if($recomone['full']=='已满') echo 'checked="checked"';?>>已满
				<input type="radio" id="full" name="full" value="未满" <?php if($recomone['full']=='未满') echo 'checked="checked"';?>>未满
			</td>
		</tr>
		<tr>
			...
			<td>
			  <select id="qqtype" name="qqtype" STYLE="width:100px;" >
			    <option value="直属群" <?php if($recomone['type']=='直属群') echo "selected";?>>直属群</option>
				<option value="地方群"  <?php if($recomone['type']=='地方群') echo "selected";?>>地方群</option>
				</select>				
			</td>
		</tr>
		<tr id="cityarea"   <?php if($recomone['type']=='直属群') echo "style='display:none'";?>>
