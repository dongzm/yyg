...
function colorpicker(showid,fun,input) {
	for (i=0;i<2;i++) {
	  for (j=0;j<6;j++) {
	...
	colorTable='<div style="position:relative;width:253px; height:176px"><table width=253 border="0" cellspacing="0" cellpadding="0" style="border:1px #69f solid;border-bottom:none;border-collapse: collapse" bordercolor="000000">'
			   ...
			   +'<td width="3"><td><input type="text" name="HexColor" size="7" id="input_colorId" style="border:inset 1px;font-family:Arial;" value="#000000"></td><td class="color_window_td"><a href="javascript:;" onclick="clear_title();"> 清除颜色</a></td><td><a href="javascript:;" onclick="closeBox();" class="close-own">关闭</a></td></tr></table></td></table>'
