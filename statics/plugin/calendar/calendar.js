...
style.href = 'plugin/calendar/calendar-blue.css';
...
if (Calendar.is_ie) this.showAt(p.x, p.y-246);
else this.showAt(p.x, p.y-240);
...
Calendar.setup = function (params) {
	...
	triggerEl["on" + params.eventName] = function() {
		...
		cal.refresh();
		if (!params.position){
			cal.showAtElement(params.button || params.displayArea || params.inputField, 0);
